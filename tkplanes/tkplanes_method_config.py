...
from tkplanes.data.datamanagers.base_datamanager import VanillaDataManagerConfig
from tkplanes.kplanes.kplanes import KPlanesModelConfig
...
kplanes_dynamic_method = MethodSpecification(
    config=TrainerConfig(
        ...
        # gradient_accumulation_steps=1, # TODO: difference between nerfstudio versions???
        ...
        pipeline=VanillaPipelineConfig(
            ...
            model=KPlanesModelConfig(
                ...
                grid_base_resolution=[8, 8, 8, 20],  # time-resolution should be half the time-steps                
        ...
        optimizers={
            ...
            "decoder": {
                "optimizer": AdamOptimizerConfig(lr=2e-5, eps=1e-12),
                "scheduler": CosineDecaySchedulerConfig(warm_up_end=512, max_steps=1000000),
            },
            #"ray_bundle_encoder": {
